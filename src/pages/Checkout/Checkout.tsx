        ...
        <div className="flex w-full flex-col items-center bg-white-a700">
            ...
            <div className="flex flex-col gap-20 lg:gap-20 md:gap-[60px] sm:gap-10">
                ...
                <div className="flex w-[42%] items center justify-center gap-[21px] md:w-full md:flex-col">
                    <div className="w-[38%] flex flex-wrap items-center justify-center gap-6 md:w-full">
                        <Text
                            size="texts"
                            as="p"
                            className="flex h-[56px] w-[56px] items-center justify-center rounded-[28px] border-2 border-solid border-gray-500 text-center text-[24px] font-medium text-gray-800 lg:text-[20px]"
                        >
                            1
                        </Text>
                        <Text
            ...
            <div className="flex items-center md:flex-col">
                <div className="flех w-[46%] flex-col gap-8 md:w-full">
                    ...
                    <div className="flex flex-col items-start gap-4">
                        <Text as="p" className="text-[18px] font-normal text-gray-508 lg:text-[15px]">
                            Address
                        </Text>
                            ...
                            <div className="flex w-[46%] flex-col items-start gap-3.5 md:w-full">
                                ...
                                <Input shape="square" name="Zip Code Input" className="w-[74%] !border" />
                                    ...
                                    <div className="flex items-center gap-4 border border-solid border-blue_gray-100 p-[30px] sm:p-4">
                                        ...
                                        <Text as="p" className="text-[18px] font-normal text-gray-800 1g:text-[15px]">
                                            Credit Card
                                        </Text>
                                    </div>
                                    <Button
                                    ...
                                    variant="outline"
                                    shape="square"
                                    leftIcon={<Img src="images/img_paypal.svg" alt="Paypal" className="h-[48px] w-[40px]" />}
                    ...
                    <div className="mt-[30px] flex justify-end gap-8 self-stretch md:flex-col">
                        ...
                        <Button shape="square" className="min-w-[244px] px-[34px] mt-[74px] font-medium sm:px-4 flex flex-row items-center justify-center text-center cursor-pointer whitespace-nowrap rounded-[0px] h-[60px] text-[18px] bg-gray-800 text-white-a700">
                            Checkout
                        </Button>
                    </div>
                </div>
