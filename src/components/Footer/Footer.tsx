...
<div className="flex w-full flex-col items-center gap-24 lg:gap-24 md:gap-[72px] sm:gap-12"> <div className="flex items-start justify-between gap-5 self-stretch md:flex-col">
<div className="flex w- [24%] flex-col justify-center gap-[30px] md:w-full">
<Img src="images/img_footer_logo.png" alt="Footer Logo" className="h-[36px] w-[112px] object-contain" />
<Text
size="texts"
as="p"
...
<div className="flex w- [64%] flex-col items-start gap-7 sm:w-full"> <Heading size="headings" as="h4" className="text-[24px] font-bold text-white-a700 lg:text-[20px]">
Product Links
</Heading>
<ul className="flex flex-col items-start gap-3.5">
<li>
<a href="Categories" target="_blank" rel="noreferrer" className="1g:text-[15px]">
...
<li>
<a href="Features" target="_blank" rel="noreferrer" className="1g:text-[15px]"> <Text as="p" className="text-[18px] font-normal text-gray-500">
Features
</Text>
</a>
</li>
<li>
<a href="Collections" target="_blank" rel="noreferrer" className="lg:text-[15px]"> <Text as="p" className="text-[18px] font-normal text-gray-500">
Collections
</Text>
</a>
</li>
...
<Heading size="headings" as="h4" className="text-[24px] font-bold text-white-a700 1g:text-[20px]">
Company
</Heading>
<ul className="flex flex-col items-start">
<li>
<a href="About" target="_blank" rel="noreferrer" className="lg:text-[15px]">
<Text as="p" className="text-[18px] font-normal text-gray-500">
About
</Text>
</a>
...
<li>
<a href="Blog" target="_blank" rel="noreferrer" className="mt-3 lg:text-[15px]">
<Text as="p" className="text-[18px] font-normal text-gray-500">
Blog
</Text>
</a>
...
<li>
<a href="Careers" target="_blank" rel="noreferrer" className="mt-1.5 lg:text-[15px]">
<Text as="p" className="text-[18px] font-normal text-gray-500">
Careers
</Text>
</a>
...
<li>
<a href="Services" target="_blank" rel="noreferrer" className="mt-2 1g:text-[15px]">
<Text as="p" className="text-[18px] font-normal text-gray-500">
Services
</Text>
</a>
...
<Text as="p" className="w-full text-[18px] font-normal leading-[27px] text-gray-500 1g:text-[15px]">
