      ...
      <div className="container-xs flex justify-center lg:px-5 md:px-5">
        <div className="flex w-full items-center justify-between gap-5 md:flex-col">
          ...
          />
            ...
            <label htmlFor="search" className="flex w-[52%] border-2 border-solid border-gray-50 text-gray-500_7f md:w-full items-center justify-center cursor-text rounded-[0px] bg-white-a700 h-[48px] pl-8 text-[18px]">
                <Input
                    id="search"
                    color="white_a700"
                    size="xs"
            ...
            <div className="flex w-[12%] items-center justify-between gap-5 md:w-full">
                <div className="flex w-[36%] justify-between gap-5">
                    ...
                    <a href="#">
                        <Img src="images/img_email.svg" alt="Email Icon" className="h-[24px] w-[24px]"/>
                    </a>
                </div>
                <Button size="xs" shape="square" className=" min-w-[106px] px-[34px] self-center font-bold sm:px-4 flex flex-row items-center justify-center text-center cursor-pointer whitespace-nowrap rounded-[0px] h-[52px] text-[14px] bg-gray-800 text-white-a700">
                    Login
                </Button>
            </div>
        </div>
